...
(4, 2, 1, N'Heo Thịt Truyền Thống', N'Heo Lai', 40, 4, 1500000, 3200000, 128000000, 
 N'Heo thịt được nuôi theo phương pháp truyền thống.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-10', '2025-05-10'),
(4, 2, 2, N'Heo Giống Móng Cái', N'Móng Cái', 30, 3, 2500000, 5000000, 150000000, 
 N'Heo giống Móng Cái thuần chủng, dễ nuôi, sinh sản tốt.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-12', '2025-05-12'),
(4, 2, 3, N'Heo Rừng Lai F1', N'Heo Rừng Lai', 20, 2, 3000000, 6000000, 120000000, 
 N'Heo rừng lai F1, chất lượng thịt thơm ngon.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-13', '2025-05-13'),
(4, 2, 4, N'Heo Siêu Nạc Hòa Phát', N'Heo Siêu Nạc', 60, 6, 2000000, 4000000, 240000000, 
 N'Heo siêu nạc tăng trưởng nhanh, tỉ lệ nạc cao.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-14', '2025-05-14'),
(4, 2, 5, N'Heo Mẹ Landrace', N'Landrace', 15, 2, 3500000, 7000000, 105000000, 
 N'Heo mẹ Landrace có khả năng sinh sản cao.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-15', '2025-05-15'),
(4, 2, 6, N'Heo Con Siêu Nạc 2 Tuần Tuổi', N'Siêu Nạc', 50, 5, 1500000, 2000000, 100000000, 
 N'Heo con 2 tuần tuổi, khỏe mạnh.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-16', '2025-05-16'),
(4, 2, 7, N'Heo Đen Lạng Sơn', N'Heo Đen', 25, 3, 2500000, 4500000, 112500000, 
 N'Heo đặc sản Lạng Sơn, thịt chắc ngọt.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-17', '2025-05-17'),
(4, 3, 1, N'Heo Thịt Trắng Hòa Bình', N'Heo Trắng', 35, 4, 1800000, 3300000, 115500000, 
 N'Heo nuôi tại trại hữu cơ Hòa Bình.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-18', '2025-05-18'),
(4, 3, 2, N'Heo Giống Yorkshire', N'Yorkshire', 28, 3, 2700000, 5300000, 148400000, 
 N'Heo giống Yorkshire, tăng trưởng tốt.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-19', '2025-05-19'),
(4, 3, 3, N'Heo Rừng Lai Đen', N'Heo Rừng Đen', 22, 2, 2800000, 5800000, 127600000, 
 N'Heo rừng đen chất lượng thịt cao.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-20', '2025-05-20'),
(4, 3, 4, N'Heo Siêu Nạc CP', N'CP', 55, 6, 2100000, 4100000, 225500000, 
 N'Heo siêu nạc do CP cung cấp giống.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-21', '2025-05-21'),
(4, 3, 5, N'Heo Mẹ Yorkshire', N'Yorkshire', 18, 2, 3300000, 6800000, 122400000, 
 N'Heo mẹ khỏe mạnh, khả năng đẻ nhiều.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-22', '2025-05-22'),
(4, 4, 6, N'Heo Con 3 Tuần Tuổi', N'Heo Trắng', 45, 5, 1600000, 2200000, 99000000, 
 N'Heo con đã tách mẹ, sẵn sàng xuất bán.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-23', '2025-05-23'),
(4, 4, 7, N'Heo Đặc Sản Quảng Nam', N'Heo Mán', 30, 4, 2600000, 4600000, 138000000, 
 N'Heo địa phương nuôi tại miền núi Quảng Nam.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-24', '2025-05-24'),
(4, 4, 1, N'Heo Thịt Lai Lốc', N'Lai Lốc', 38, 5, 1750000, 3250000, 123500000, 
 N'Heo lai lốc chất lượng cao.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-25', '2025-05-25'),
(4, 4, 2, N'Heo Giống Duroc', N'Duroc', 26, 3, 2800000, 5400000, 140400000, 
 N'Heo giống Duroc đực giống chuyên dùng lai tạo.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-26', '2025-05-26'),
(4, 5, 3, N'Heo Rừng Lai Nọc', N'Heo Rừng Nọc', 12, 2, 3200000, 6200000, 74400000, 
 N'Heo rừng nọc chất lượng tốt, giống khỏe.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-27', '2025-05-27'),
(4, 5, 4, N'Heo Siêu Nạc Giống Thái', N'Giống Thái', 60, 6, 1950000, 3900000, 234000000, 
 N'Heo siêu nạc giống Thái Lan.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-28', '2025-05-28'),
(4, 6, 5, N'Heo Mẹ F1', N'Lai F1', 20, 2, 3400000, 6900000, 138000000, 
 N'Heo mẹ lai F1, sinh sản tốt.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-29', '2025-05-29'),
(4, 6, 6, N'Heo Con CP', N'CP', 48, 4, 1700000, 2300000, 110400000, 
 N'Heo con CP, chất lượng ổn định.', 'https://i.ibb.co/SXtVYJ12/default-pig.jpg', '2025-04-30', '2025-05-30');
