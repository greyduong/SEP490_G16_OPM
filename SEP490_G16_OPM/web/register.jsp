...
<html>
    <head>
        ...
        <title>Đăng ký | Online Pig Market</title>
    ...
    <body>
        ...
        <main class="w-90 mx-auto mb-5">
            <div class="ring-1 ring-slate-500/10 rounded-lg p-4">
                <div class="font-bold text-xl">Đăng ký</div>
                <div class="text-slate-500 mb-3">Tạo tài khoản</div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="flex flex-col mb-3">
                        ...
                        <select name="role" id="role" class="text-slate-600 border border-slate-300 rounded-lg px-1 py-1">
                    ...
                    <div class="text-center mb-3">Đã có tài khoản? <a class="!text-slate-500 hover:!text-slate-800" href="${pageContext.request.contextPath}/login">Đăng nhập</a></div>
                    <button class="!bg-gray-700 hover:!bg-gray-800 text-white w-full rounded-lg py-1">Đăng ký</button>
                </form>
            </div>
        </main>
