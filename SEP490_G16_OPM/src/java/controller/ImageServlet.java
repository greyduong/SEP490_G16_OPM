...
import static config.UploadConfig.BASE_UPLOAD_PATH;
...
public class ImageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String folder = request.getParameter("folder");   // pigs, farms, etc.
        String file = request.getParameter("file");       // abc.jpg
        ...
        File imageFile = new File(BASE_UPLOAD_PATH + "/" + folder + "/" + file);
        if (!imageFile.exists()) {
